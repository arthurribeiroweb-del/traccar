...
public final class Keys {
        ...
        /**
         * Cooldown between radar overspeed notifications for the same device and
         * geofence. Value in seconds.
         */
        ...
        /**
         * Optional path to static radar radius overrides file (JSON object keyed by
         * externalId).
         */
        ...
        /**
         * Default radar trigger radius in meters when a radar entry has no explicit
         * radius.
         */
        ...
        /**
         * Create default "kit basico" notifications (geofence, ignition, overspeed,
         * maintenance) for new users.
         */
         ...
         * when using GPS-only (no physical odometer) or if device reports invalid or
         * zero odometer values.
        ...
        /**
         * Webhook URL for forwarding daily summary data (e.g. to n8n for WhatsApp
         * notifications).
         * If not set, the daily summary webhook is disabled.
         */
        public static final ConfigKey<String> DAILY_SUMMARY_WEBHOOK_URL = new StringConfigKey(
                        "dailySummary.webhook.url",
                        List.of(KeyType.CONFIG));

        /**
         * Optional Bearer token for authenticating daily summary webhook requests.
         */
        public static final ConfigKey<String> DAILY_SUMMARY_WEBHOOK_TOKEN = new StringConfigKey(
                        "dailySummary.webhook.token",
                        List.of(KeyType.CONFIG));
